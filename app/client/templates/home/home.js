...
Template.Home.onRendered(function () {
    ...
    if(window.location.search === '?embed=true'){
        ...
        var latlngPoint = new L.LatLng(41.07241230197147,-71.081298828125);
        map.fireEvent('click', {
            latlng: latlngPoint,
            layerPoint: map.latLngToLayerPoint(latlngPoint),
            containerPoint: map.latLngToContainerPoint(latlngPoint)
        });
        var latlngPoint2 = new L.LatLng(41.78192129773195,-71.11038208007811);
        map.fireEvent('click', {
            latlng: latlngPoint2,
            layerPoint: map.latLngToLayerPoint(latlngPoint),
            containerPoint: map.latLngToContainerPoint(latlngPoint)
    ...
    function loadProfile(url) {
        ...
        let token = Meteor.settings.public.mapboxToken;
        var tempUrl = 'https://api.tiles.mapbox.com/v4/surface/villeda.92hp8pvi.json?layer=temp&fields=temp_f&z=6&access_token='+token+'&encoded_polyline='+url;
        var elevUrl = 'https://api.tiles.mapbox.com/v4/surface/mapbox.mapbox-terrain-v1.json?layer=contour&fields=ele&zoom='+qZ+'&access_token='+token+'&encoded_polyline='+url;
        $.when(
            $.ajax({
                type: 'GET',
                url:tempUrl
